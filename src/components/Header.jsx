...
function Header() {
    ...
    return (
        <div className="px-4 md:px-10 lg:px-28 xl:px-44 h-20 bg-white shadow flex gap-16 items-center fixed z-40 top-0 bottom-0 w-full">
            <a href=''>
            ...
            <div className='ml-auto lg:hidden text-4xl py-2 text-gray-400' onClick={() => setOpen(!open)}>
                <GiHamburgerMenu />
            </div>

            <div className={" lg:hidden absolute top-20 left-0 right-0 px-5 w-full transition ease-in-out delay-150 -translate-x-full" + (open ? '-translate-x-full' : '')}>
                <div className='lg:hidden py-10 px-7 w-full bg-[#3B3054] rounded-xl text-xl text-white'>
                    <ul className='pb-7 border-b border-gray-500 flex flex-col gap-8 items-center font-semibold tracking-wider'>
                    ...
                    <div className='pt-7 flex flex-col gap-6 items-center w-full'>
                        ...
                        <button className='h-12 w-full text-xl text-white font-medium bg-teal-500 rounded-3xl'>
                            Sign up
                        </button>
                    </div>  
                </div>
            ...
            {/* desktop nav view */}
            <ul className='hidden lg:flex gap-6 items-center font-medium text-gray-400'>
                <li><a href=''>Features</a></li>
                <li><a href=''>Pricing</a></li>
                <li><a href=''>Resources</a></li>
            </ul>
            <div className='ml-auto hidden lg:flex gap-6 items-center'>
                ...
                <a href=''>
                    <button className='text-white h-8 lg:w-20 xl:w-24 font-medium bg-teal-500 rounded-full'>
                        Sign up
                    </button>
                </a>
            </div>  
