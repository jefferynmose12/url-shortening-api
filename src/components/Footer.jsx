...
function Footer() {
    return (
        <footer className='py-12 lg:px-28 xl:px-44 bg-[#232127] text-white flex flex-col gap-10 lg:flex-row items-center lg:items-start justify-between'>
            <a href=''>
            ...
            <div className='flex flex-col lg:flex-row gap-8 lg:gap-16 xl:gap-20 items-center lg:items-start text-center lg:text-left justify-between'>
                <div className="">
                    <h4 className='font-semibold'>Features</h4>
                    <ul className='pt-2 flex flex-col gap-1 text-gray-400'>
